...
```
Like the name suggests, it inverts the motor speed automatically when the code is compiled it doesnt give you eye cancer 😄:
```
Motor.GetCount(port)
```
...
```
This is what I would use for basic movement as you can control the speed of each motor individually  
Its the excatly replica of the Move Tank block in EV3-G
## Sensors
```
print("Hello world")
```
