...
The Pybricks team has already written a very well-documented tutorial on how to get started [here][pybricks installation].
...
Instructions on how to interface with EV3 devices can be found more specifically [here][pybricks docs ev3devices] and there is also a `DriveBase` class that you can use [here][pybricks docs robotics].
...
The documentation for using ev3dev sensors with Pybricks can be found [here](pybricks docs ev3devsensor).

Conveniently, someone has also written code to use the Hitechnic Color Sensor at [this random GitHub issue](hitechnic color sensor issue).
